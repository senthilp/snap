	...
	var DEFAULT_AVATAR_ICON = 'data:image/jpeg;base64,',
		...
		TEMPLATES = {
			...
			videoContainer: '<div id="' + VIDEO_CONTAINER_ID + '" style="position: absolute;height: 400px; width: 500px;left: 50%;top: 25%;margin-left:-250px; background: #000;z-index: 9999;display: none;">'
							...
							+ '<span class="iclose" style="display:inline-block;position:absolute;top:11px;right:21px;cursor:pointer;padding: 2px 6px;background: #CCC;float:right;border-radius:50%;color:red;font-weight:bold;font-size:23px;">X</span>'
							+ '<video style="padding: 10px 20px;width:460px;" autoplay title="Click camera below when ready"></video>'
							+ '<canvas style="display:none"></canvas>'
							+ '</div>'
							+ '<div style="border: 1px solid #BBBBBB;height: 40px;padding: 0 20px;background: -webkit-linear-gradient(top, #FFFFFF, #D7D7D7);">'
							+ '<div class="icam" style="cursor:pointer;width: 70px;height: 30px;margin: 4px auto;border: 1px solid #BBBBBB;border-radius: 15%;background: url(\' ' + DEFAULT_CLICK_ICON + '\') no-repeat 50% 50%;"></div>'							
							+ '</div>'
							+ '</div>'
		},
		...
		snap: function(config) {
			...
			var n = navigator, // caching navigator object to enable minification
				...
				capture = function(masterElem) {
					...
					masterJClone.css('background', 'url(\''+ imgSrc + '\') no-repeat 50% 50%');
				...
				init = function(elem) {
					var jElem = $(elem),
						icon = 'background:' + getBackgroundStyle(cameraIcon) + '; cursor:pointer;';
			...
			return this.each(function() {
				...
				if(typeof n.getUserMedia == "undefined") {
					$(this).css('background', getBackgroundStyle(avatarIcon));
					return;
				}
				// Initinalize snap
				init(this);
